    ...
    $(document).ready(function () {
        ...
        if(typeURLMedia == 'movie'){
            ...
            .then(function (data) {
                        ...
                        `
                        document.title = data.original_title + ` (${data.release_date.substring(0,4)})`
                        ...
                        `
                            <h1>${data.original_title} (${data.release_date.substring(0,4)})</h1>
                        `;
        ...
        if(typeURLMedia == 'tv'){
            ...
            .then(function (data) {
                        ...
                        `
                            <img src="http://image.tmdb.org/t/p/original${data.backdrop_path}" id="poster_path${data.id}" alt="${data.original_title}">
                        `
                        document.title = data.name + ` (${data.first_air_date.substring(0,4)})`
                        ...
                        titleMedia.innerHTML = 
                        `
                            <h1>${data.name} (${data.first_air_date.substring(0,4)})</h1>
                        `;
